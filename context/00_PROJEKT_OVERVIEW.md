...
- **Hlavní stránka**: `Ostatni/Frontend/index.php`
- **Entry point**: `Ostatni/index.php` (přesměrování)
...
### Instalace
1. Importovat databázi: `Ostatni/Database/1,db.sql`
2. Nastavit přístupové údaje v `Ostatni/Database/db.php`
